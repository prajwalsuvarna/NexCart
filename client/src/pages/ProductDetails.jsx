...
const ProductDetails = () => {
    ...
    const getRelatedProducts=async(pid,cid)=>{
        try {
            const res=await fetch(`${import.meta.env.VITE_API_URL}/api/product/related-products/${pid}/${cid}`,{
                method:"GET"
                })
    ...
    const getProduct=async()=>{
        try {
            const res=await fetch(`${import.meta.env.VITE_API_URL}/api/product/get-product/${slug}`,{
                method:"GET",
                headers:{
